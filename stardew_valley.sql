...
CREATE TABLE `tbcrescimentolavouras` (
  ...
  `Estagio_1_imagem` TEXT DEFAULT NULL,
  `Estagio_2_imagem` TEXT DEFAULT NULL,
  `Estagio_3_imagem` TEXT DEFAULT NULL,
  `Estagio_4_imagem` TEXT DEFAULT NULL,
  `Estagio_5_imagem` TEXT DEFAULT NULL,
  `Colheita_1_imagem` TEXT DEFAULT NULL,
  `Colheita_2_imagem` TEXT DEFAULT NULL,
